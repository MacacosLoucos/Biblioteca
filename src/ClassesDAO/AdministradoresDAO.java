...
public class AdministradoresDAO extends PessoasDAO implements IFuncoesADM {
    ...
    /*Método para encontar o último exemplar de um livro*/
    private char encontrarExemplar(Livros l) {
        
        PreparedStatement n = null;
        
        char letra = 0;
        
        String sql = "SELECT MAX(exe_numero) as m FROM tb_exemplar WHERE tb_livros_liv_id = ?;";
    ...
    private void adicionarExemplares(Livros l) {
        ...
        if (id == 0) {
            ...
            letra = this.encontrarExemplar(l);
            letra++;
        }
